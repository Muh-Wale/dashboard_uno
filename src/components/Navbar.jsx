...
import { setActiveMenu, setActiveSearch, setActiveNav, setIsClicked } from '../store/slices/uiSlice';
import { setScreenSize } from '../store/slices/screenSlice';
import PropTypes from 'prop-types'; // Import PropTypes

const Navbar = ({ selectedLink }) => {
    const dispatch = useDispatch();
    const { activeMenu, activeSearch, activeNav, isClicked } = useSelector((state) => state.ui);
...
Navbar.propTypes = {
    selectedLink: PropTypes.string.isRequired, // Validate selectedLink as a required string
};
