                ...
                <div>
                    ...
                    <div>
                        <label className="flex items-center cursor-pointer mt-3">
                            ...
                            <span className="ml-3">I send or receive digital cureency</span>
                        </label>
                        ...
                        <label className="flex items-center cursor-pointer mt-3">
                            ...
                            <span className="ml-3">I receive merchant order</span>
                        </label>
                        ...
                        <label className="flex items-center cursor-pointer mt-3">
                            ...
                            <span className="ml-3">There are recommendation for my account</span>
                        </label>
                    </div>
                </div>
